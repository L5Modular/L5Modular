...
class ViewMakeCommandTest extends MakeCommandTestCase
{
    private $command = 'make:module:view';
    ...
    public function Should_Generate_When_ModuleExists()
    {
        ...
        $this->assertFileExists($this->modulePath . '/' . $this->getConfiguredFolder($this->configStructureKey) . '/' . $this->componentName . '.blade.php');
    }
