...
class EventMakeCommandTest extends MakeCommandTestCase
{
    private $command = 'make:module:event';

    private $componentName = 'FooEvent';

    private $configStructureKey = 'events';
